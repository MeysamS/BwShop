...
AnsiConsole.Write(new FigletText("Reviews Bounded Context Hosting").Centered().Color(Color.FromInt32(new Faker().Random.Int(1, 255))));
...
namespace BwShop.Reviews.WebHost
{
